...
export const SettingsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const getCardStyle = (danger = false): ViewStyle => ({
    ...styles.card,
    ...(danger
      ? {
        ...
        <Card style={getCardStyle()}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingDescription}>Receba ofertas e novidades</Text>
            </View>
            <Switch
        ...
        <Card style={getCardStyle()}>
          ...
          <View style={styles.settingItem}>
            <View style={styles.settingInfo}>
              ...
              <Text style={styles.settingDescription}>Em breve disponível</Text>
            </View>
            <Switch
              value={darkMode}
