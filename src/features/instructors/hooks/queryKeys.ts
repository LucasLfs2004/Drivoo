export const instructorQueryKeys = {
  ...
  availabilityCalendar: () => [...instructorQueryKeys.all, 'availability-calendar', 'me'] as const,
  ...
  financialSummary: (params: unknown) =>
    [...instructorQueryKeys.all, 'financial', 'summary', 'me', params] as const,
  financial: () => [...instructorQueryKeys.all, 'financial', 'me'] as const,
  detail: (instructorId: string) => [...instructorQueryKeys.all, 'detail', instructorId] as const,
