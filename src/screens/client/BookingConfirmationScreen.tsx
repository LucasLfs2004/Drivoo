...
import { BookingData, BookingConfirmationData, BookingValidationResult } from '../../types/booking';
...
export const BookingConfirmationScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const calculatePaymentInfo = (basePrice: number) => {
  ...
  const paymentInfo = calculatePaymentInfo(bookingData.price);

  // Validate booking data
  const validateBookingData = (data: BookingData): BookingValidationResult => {
