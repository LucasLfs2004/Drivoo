        ...
        <View style={styles.container}>
            ...
            {!hasReachedMinimum && (
                <Typography variant="caption" color="secondary" style={styles.minInfo}>
                    Mínimo de {minimumLessons} aulas para tirar a CNH
                </Typography>
            )}
        </View>
    );
...
export const CategoryProgressSection = React.memo(
    ...
    (prevProps, nextProps) => {
        ...
        return (
            ...
            prevProps.maxLessons === nextProps.maxLessons &&
            prevProps.recommendedLessons === nextProps.recommendedLessons &&
            prevProps.minimumLessons === nextProps.minimumLessons
        );
    }
);
